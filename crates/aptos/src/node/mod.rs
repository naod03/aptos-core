...
/// Checks the network connectivity of a node by dialing the node using noise
#[derive(Parser)]
pub struct CheckNetworkConnectivity {
    ...
    /// Examples include: `devnet`, `testnet`, `mainnet`.
    #[clap(long)]
...
impl CliCommand<String> for CheckNetworkConnectivity {
    ...
    async fn execute(self) -> CliTypedResult<String> {
        ...
        let node_address_args = NodeAddressArgs {
            ...
            chain_id: ChainId::from_str(&self.chain_name.to_string())?,
        };
